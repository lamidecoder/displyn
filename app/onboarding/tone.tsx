...
const BG_TONE = require('../../assets/images/onboarding-bg-3.jpg');
...
export default function ToneScreen() {
  ...
  return (
    <View style={s.root}>
      <Image source={BG_TONE} style={s.bgImg} resizeMode="cover" />
...
const makeStyles = (t: any) =>
  StyleSheet.create({
    ...
    toneName: { fontSize: 16, fontWeight: '700', color: '#FFFFFF', marginBottom: 4 },
    toneDesc: { fontSize: 13, color: 'rgba(255,255,255,0.75)', lineHeight: 18 },
